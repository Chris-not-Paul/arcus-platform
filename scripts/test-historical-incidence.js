...
assert.equal(torinoEvents.length, 41);
assert.equal(torino.numerator_count, 41);
...
assert.equal(torino.provincial_rate_per_100, 3.191);
assert.equal(torino.collapse_rate_per_100_ainop_bridges, 3.191);
assert.equal(torino.national_rate_per_100, 0.58);
assert.equal(torino.relative_to_national, 5.5);
assert.equal(torino.dataset_scope, "professional");
assert.equal(torino.dataset_version, "arcus-professional-2026.09.08");
...
assert.equal(index.metadata.total_arcus_cases, 261);
assert.equal(index.metadata.total_sources, sources.length);
assert.equal(index.metadata.national_rate_per_100_ainop_bridges, 0.58);
...
assert.equal(openRebuilt.metadata.total_arcus_cases, 261);
assert.equal(openRebuilt.metadata.included_year_max, 2026);
assert.equal(openRebuilt.metadata.national_rate_per_100_ainop_bridges, 0.58);
assert.equal(openTorino.relative_to_national, 5.5);
