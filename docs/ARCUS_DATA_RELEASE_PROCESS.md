...
MASTER_RESEARCH.xlsx (internal, read-only)
  -> common header-based validation and lossless normalization
     -> Open release candidate + quality gate
        -> private-data/open/releases/arcus-open-2026.3 (immutable)
